    ...
    return (
        <nav>
            <div className={`${navbarBackground}${flexBetween} fixed top-0 z-30 w-full py-6 bg-black`}>
                <div className={`${flexBetween} mx-auto w-5/6`}>
                    ...
                    <div className={`${flexBetween} w-full `}>
                       ...
                       <button className="rounded-full bg-indigo-500 p-2" onClick={() => setIsMenuToggled(!isMenuToggled)}>
            ...
            {!isAboveMediumScreens && isMenuToggled && (
                <div className="fixed right-0 bottom-0 z-40 h-full w-[300px] gradient-background1 drop-shadow-xl">
                    {/* Close ICON */}
